...
function App({lakes}: {lakes:string[]}){
    ...
    return(
        //best practice https://www.linkedin.com/learning/react-js-essential-training-14836121/adding-keys-to-list-items?autoSkip=true&autoplay=true&contextUrn=urn%3Ali%3AlyndaLearningPath%3A593715e0498e9e9be7fb8506&resume=false&u=2198250
        <div>
            <HelloWorld library="React" message="have fun"/>
            <HelloAgain name="Caleb" age={23} />
            <ul>
                { lakes.map((lake,i) =>((<li  key ={i}>{lake}</li>)))}
            </ul>
        </div>
